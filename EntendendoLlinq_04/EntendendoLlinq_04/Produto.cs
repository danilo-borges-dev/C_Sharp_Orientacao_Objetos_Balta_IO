namespace EntendendoLlinq_04
{
    internal class Produto
    {
        ...
        public List<Produto> GetAll ()
        {
            ...
            listaProdutos.Add(new Produto(12, "Arroz", "Saco com 5kg Tipo 1", 5.80M, "Alimentação"));
            listaProdutos.Add(new Produto(5, "Feijão", "Saco com 1kg", 4.25M, "Alimentação"));
            listaProdutos.Add(new Produto(7, "Sabão de Coco", "Pacote com 12 Unidades", 8.0M, "Limpeza"));
            listaProdutos.Add(new Produto(15, "Suco de Limão", "Procte com 30g", 0.30M, "Alimentação"));
